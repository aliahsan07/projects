...
int main () {
    printf ("******************************************\n");
    printf ("* Card Test 1: Smithy START **************\n");
    printf ("******************************************\n\n");
    ...
    printf ("Player1 plays Smithy (player1 draws 3 cards)...\n\n");
    
    printf ("Game.handCount[player1] = %d\n", Game.handCount[player1]);
    massert (Game.handCount[player1] == prevHandCount1 + 2, "Incorrect number of cards for player1's hand");
    printf ("(Expecting 7)\n\n");
    
    printf ("Game.deckCount[player1] = %d\n", Game.deckCount[player1]);
    massert (Game.deckCount[player1] == prevDeckCount1 - 3, "Incorrect number of cards for player1's deck");
    printf ("(Expecting 2)\n\n");
    
    printf ("Game.handCount[player2] = %d\n", Game.handCount[player2]);
    massert (Game.handCount[player2] == prevHandCount2, "Incorrect number of cards for player2's hand");
    printf ("(Expecting 0)\n\n");

    printf ("Game.deckCount[player2] = %d\n", Game.deckCount[player2]);
    massert (Game.deckCount[player2] == prevDeckCount2, "Incorrect number of cards for player2's deck");
    printf ("(Expecting 10)\n\n");
    
    printf ("******************************************\n");
    printf ("* Card Test 1: Smithy FINISHED ***********\n");
    printf ("******************************************\n\n");
}
