...
int ref_minion(int choice1, int choice 2, int handPos, int currentPlayer, struct gameState *state){
	...
	else if (choice1)		//discard hand, redraw 4, other players with 5+ cards discard hand and draw 4
	{
		...
		//other players discard hand and redraw if hand size > 3
...
int ref_village(int currentPlayer, struct gameState *state, int handPos){
	//+1 Card
	drawCard(currentPlayer, state);
...
int ref_steward(int currentPlayer, struct gameState *state, int choice1, int choice2, int choice3, int handPos){
	if (choice1 == 1)
	{
		//+2 cards
		drawCard(currentPlayer, state);
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case council_room:
		return ref_council_room(currentPlayer, state, handPos);
    ...
    case village:
		return ref_village(currentPlayer, state, handPos);
    ...
    case minion:
		return ref_minion(choice1, choice2, handPos, currentPlayer, state);
     
		
    case steward:
		return ref_steward(currentPlayer, state, choice1, choice2, choice3, handPos);
