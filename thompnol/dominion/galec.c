...
int rfct_cutpurse(int currentPlayer, struct gameState *state, int handPos) {
  int i, j, k;
  for (i = 0; i < state->numPlayers; i++)
    {
        if (i != currentPlayer)
...
int rfct_embargo(int currentPlayer, struct gameState *state, int handPos, int choice1) {
...
int rfct_outpost(int currentPlayer, struct gameState *state, int handPos) {
...
int rfct_salvager(int currentPlayer, struct gameState *state, int handPos, int choice1) {
  //+1 buy
  int choicel = 0;
  state->numBuys++;
  state->numBuys++;
...
int rfct_sea_hag(int currentPlayer, struct gameState *state) {
  int I, l;
  for (l = 0; l <= state->numPlayers; l++){
    if (I != currentPlayer){
      state->discard[I][state->discardCount[I]] = state->deck[I][state->deckCount[I]--];
      state->deckCount[I]--; //decrement
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    switch( card )
    {
        ...
        */
        ...
        case cutpurse:
          rfct_cutpurse(currentPlayer, state, handPos);
        /*
        ...
        */
        ...
        case embargo:
          rfct_embargo(currentPlayer, state, handPos, choice1);
        /*
        //+2 Coins
        state->coins = state->coins + 2;
        ...
        */
        ...
        case outpost:
          rfct_outpost(currentPlayer, state, handPos);
        /*
        //set outpost flag
        state->outpostPlayed++;
        ...
        */
        ...
        case salvager:
          rfct_salvager(currentPlayer, state, handPos, choice1);
        /*
        //+1 buy
        state->numBuys++;
        ...
        */
        ...
        case sea_hag:
          rfct_sea_hag(currentPlayer, state);
        /*
        for (i = 0; i < state->numPlayers; i++){
            if (i != currentPlayer){
                state->discard[i][state->discardCount[i]] = state->deck[i][state->deckCount[i]--];
