...
int numHandCards(struct gameState *state) {
  ...
  int adventure_ref(int currentPlayer, struct gameState *state, int handPos, int choice1, int choice2){
...
int feast_ref(int currentPlayer, struct gameState *state, int handPos, int choice1, int choice2){
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card )
  {
    case adventurer: //Nolan Thompson REFRACTORED
    /*  while(drawntreasure<2){
    if (state->deckCount[currentPlayer] <1){//if the deck is empty we need to shuffle discard and add to deck
    shuffle(currentPlayer, state);
    }
    ...
    return adventure_ref(currentPlayer, state, handPos, choice1, choice2);
    ...
    */
    ...
    case feast: //Nolan Thompson REFRACTORED
    /*//gain card with cost up to 5
    //Backup hand
    for (i = 0; i <= state->handCount[currentPlayer]; i++){
    temphand[i] = state->hand[currentPlayer][i];//Backup card
    ...
    //Reset Hand
    */
    return feast_ref(currentPlayer, state, handPos, choice1, choice2);
    ...
    */
    ...
    return smithy_ref(currentPlayer, state, handPos, choice1, choice2);
    ...
    */
    ...
    case embargo: //Nolan Thompson REFRACTORED
    /*
    //+2 Coins
    state->coins = state->coins + 2;
    ...
    */
    ...
    case salvager: //Nolan Thompson REFRACTORED
    /*
    //+1 buy
    state->numBuys++;
    ...
    discardCard(handPos, currentPlayer, state, 0);
    */
    return salvager_ref(currentPlayer, state, handPos, choice1, choice2);
