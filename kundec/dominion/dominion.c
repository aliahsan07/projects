...
// Reveal cards from deck until 2 Treasure cards are found.  Put those Treasure cards in the hand and discard the rest.
{
	int drawntreasure = 0;
...
//Trash a card in the hand, and gain a card costing up to $2 more than the trashed card
{
	int i;
...
//Trashing two treasure map cards from the hand = four gold on top of the deck.
{
	int i;
	int index;
