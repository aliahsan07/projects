...
remodelEffect(int currentPlayer, struct gameState *state, int choice1, int choice2, int handPos, int j){
	int i;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus){
  ...
  //uses switch to select card and perform actions
	switch( card ){
		case adventurer:
			return adventurerEffect(temphand, state, currentPlayer);
		...
		case mine:
			return mineEffect(currentPlayer, state, choice1, choice2, handPos, j);
