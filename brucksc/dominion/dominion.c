...
int mygreathall(int currentPlayer, struct gameState * state, int handPos){
            //+1 Card
            drawCard(currentPlayer, state);
...
int myoutpost(int currentPlayer, struct gameState * state, int handPos){
            //set outpost flag
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    switch( card ) 
    {
        ...
        case great_hall:
            mygreathall(currentPlayer, state, handPos);
            break;
        ...
        case outpost:
           myoutpost(currentPlayer, state, handPos);
          break; 
