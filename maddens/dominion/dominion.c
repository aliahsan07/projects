...
int adventurer_effect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus) {
...
int council_room_effect(int i, int currentPlayer, struct gameState *state, int handPos) {
...
int smithy_effect(int i, int currentPlayer, struct gameState* state, int handPos) {
  //+3 Cards
  for (i = 0; i < 3; i++) {
    drawCard(currentPlayer, state);
  }
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card )
    {
    case adventurer:
      return adventurer_effect(card, choice1, choice2, choice3, state, handPos, bonus);

    case council_room:
      return council_room_effect(i, currentPlayer, state, handPos);
    ...
    case smithy:
      return smithy_effect(i, currentPlayer, state, handPos);
