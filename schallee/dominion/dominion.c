...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
	...
	case adventurer:
	    ...
	    return adventurerCard(drawntreasure, currentPlayer, cardDrawn, temphand, z,
		    state);
	...
	case feast:
	    ...
	    return feastCard(i, currentPlayer, temphand, x, choice1, state);
	...
	case mine:
	    ...
	    return mineCard(j, currentPlayer, choice1, choice2, handPos, i, state);
