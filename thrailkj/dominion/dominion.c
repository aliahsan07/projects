...
int cardVillage(int currentPlayer, int handPos, struct gameState *state){
	//+1 Card
      drawCard(currentPlayer, state);
...
int cardGreatHall(int currentPlayer, int handPos, struct gameState *state){
	//+1 Card
      drawCard(currentPlayer, state);
...
int cardOutpost(int currentPlayer, int handPos, struct gameState *state){
	//set outpost flag
      state->outpostPlayed++;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case great_hall:
      cardGreatHall(currentPlayer, handPos, state);
    ...
    case outpost:
      cardOutpost(currentPlayer, handPos, state);
