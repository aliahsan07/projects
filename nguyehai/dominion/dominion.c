...
int useFeast(int currentPlayer, struct gameState *state, int choice1) {
...
int useMine(int currentPlayer, struct gameState *state, int choice1, int choice2, int handPos) {
    int i;
...
int useRemodel(int currentPlayer, struct gameState *state, int choice1, int choice2, int handPos) {
    int i;
    int j = state->hand[currentPlayer][choice1];  //store card we will trash
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card )
    ...
    case mine:
        useMine(currentPlayer, state, choice1, choice2, handPos);

    case remodel:
        useRemodel(currentPlayer, state, choice1, choice2, handPos);
