...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
      ...
      for (i = 0; i < state->numPlayers; i++)
	{
      ...
      return 0;*/
	  return eff_Council_Room(state, currentPlayer, handPos);
      ...
      for (i = 0; i < state->handCount[currentPlayer]; i++)
	{
      ...
      return 0;*/
	  return eff_Remodel(state, currentPlayer, choice1, choice2, handPos);
    ...
    /*  for (i = 0; i < 3; i++)
	{
      ...
      return 0;
	*/
		return eff_Smithy(state, currentPlayer, handPos);
    ...
    case village:
      ...
      return 0;
		*/
		return eff_Village(state, currentPlayer, handPos);
