...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case embargo: 
		return cardEmbargo(currentPlayer, choice1, state, handPos);
		
    case outpost:
		return cardOutpost(currentPlayer, state, handPos);
		
    case salvager:
		return cardSalvager(currentPlayer, choice1, state, handPos);
		
    case sea_hag:
		return cardSeaHag(currentPlayer, state);
		
    case treasure_map:
		return cardTreasureMap(currentPlayer, state, handPos);
    }
...
int cardEmbargo(int currentPlayer, int choice1, struct gameState *state, int handPos)
{
	//+2 Coins
    //state->coins = state->coins + 2;
...
int cardSalvager(int currentPlayer, int choice1, struct gameState *state, int handPos)
{
	//+1 buy
    //state->numBuys++;
...
int cardSeaHag(int currentPlayer, struct gameState *state)
{
	int i;
	for (i = 0; i < state->numPlayers; i++){
		if (i != currentPlayer){
...
int cardTreasureMap(int currentPlayer, struct gameState *state, int handPos)
{
