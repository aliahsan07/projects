...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case feast:
      return Feast(i, state, currentPlayer, temphand, x, choice1);
    ...
    case remodel:
      return Remodel(j, state, currentPlayer, choice1, choice2, handPos, i);
		
    case smithy:
      return Smithy(i, currentPlayer, state, handPos);
...
int Feast(int i, struct gameState* state, int currentPlayer, int *temphand, int x, int choice1) {
...
int Remodel(int j, struct gameState* state, int currentPlayer, int choice1, int choice2, int handPos, int i) {
   j = state->hand[currentPlayer][choice1];  //store card we will trash
